...
/*   Updated: 2023/01/06 12:34:36 by vcacador         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	copy_av(char **av)
{
	...
	utils()->tmp = malloc(sizeof(int) * (stack_a()->length));
	if (!stack_a()->stack || !stack_b()->stack || !utils()->tmp)
		return (1);
